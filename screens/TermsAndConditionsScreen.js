...
const termsText = `Disclaimer
 The Sample Terms are provided to you by WANDANA as a reference document only in order to facilitate the creation of an appropriate Terms of Use by you in association with your events. Your organization may face circumstances and issues that are different from or that are not covered by these Sample Terms. These Sample Terms are made available on an ‘as is’ basis without any representations, warranties or conditions that the Sample Terms comply with applicable law. We expressly disclaim all other representations, warranties and conditions, express or implied, in respect of your use of these Sample Terms. You are advised to obtain legal advice before using the Sample Terms. WANDANA shall not be held responsible for any adverse consequences arising from your use of these Sample Terms. Any reliance you place on these Sample Terms will be at your own risk. You understand and agree that WANDANA shall not be liable to you for any losses or damages which may be incurred by you in connection with your use of the Sample Terms.
Last Updated: May 9, 2018
The registration capabilities and mobile event guide (collectively, the "App") are provided to you by Data Controller. These Terms of Use apply to anyone who accesses or uses the App.
...
1. ENFORCEABILITY.
You acknowledge and agree that you have freely and voluntarily entered into these Terms of Use, have read and understood each and every provision, and any interpretation of these Terms of Use shall not be construed against us because we drafted these Terms of Use.
2. DISCLAIMER.
...
export default function TermsAndConditionsScreen({ navigation }) {
  ...
  // Optional: Enable "I Agree" only after scrolling to bottom
